export var questions = [
      ...
      {
        "question": "Many herbivorous animals, such as rabbits, will pass partially digested food in the feces only to be eaten again for further digestion. What is this process called?",
        "options": [
          "gastrulation",
          "really, really gross",
          "rumination",
      ...
      {
        "question": "Bacteria of the genus Rhizobium form nodules on the roots of leguminous plants. They are important in the food cycle because:",
        "options": [
      ...
      {
        "question": "What is the overgrowth of algae in ponds and lakes that occurs when nitrates from the soil escape into groundwater called?",
        "options": [
          "the green peril",
          "proalgacia",
          "eutrophication",
      ...
      {
        "question": "The increasing use of nitrogen fertilizers has sent more and more nitrous oxide into the atmosphere and water during the last century. Which of the following problems on earth is partly due to this fact?",
        "options": [
      ...
      {
        "question": "In almost every species of mammals, the female is only receptive to mating during a certain time of year. This period is called:",
        "options": [
          "prom",
          "diapause",
          "estrus",
      ...
      {
        "question": "In many invertebrates, especially flatworms, ovaries and testes occur in the same animal. What is such an animal called?",
        "options": [
          "a dizygote",
          "a hermaphrodite",
          "a dicot",
